...
let loginFn = require("./URL/login")
app.route('/api/link/google')
    .post(function (req,res) {
        loginFn.google_link(req,res,clientDB)
});

app.route('/api/link/pin')
    .post(function (req,res) {
        loginFn.pin_link(req,res,clientDB)
});

app.route('/api/login/pin')
    .post(function (req,res) {
        loginFn.pin_login(req,res,clientDB)
});

app.route('/api/login/google')
    .post(function (req,res) {
        loginFn.google_login(req,res,clientDB)
});

app.get('/login/discord', function (req, res) {
    loginFn.discord_login(req,res)
})
